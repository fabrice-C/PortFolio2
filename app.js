...
// Animation écriture page Accueil
...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est <span style="color: midnightblue;"><strong>Fabrice Chapier</strong></span>,')
.pauseFor(1000)
.typeString('<br/><strong>Développeur Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60;"> PhP</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #EA39ff;"> WordPress</span> !')
.pauseFor(1000)
.deleteChars(13)
...
.from(sstitreComp, {opacity: 0, duration: 0.8})
